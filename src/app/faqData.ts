...
export const FAQS: Faq[] = [
  ...
  {
    q: `How do I use the ${PROMO_CODE} code?`,
    a: `Pick a plan, hit checkout, and enter ${PROMO_CODE} in the discount field on the payment page. The total drops to zero — it is ${PROMO_LABEL} for beta testers. It is a beta-window offer, so it will not be around forever.`,
  },
  {
  ...
  },
  {
    ...
    a: "Only for the AI shorts feature, which scans the transcript for the moments worth clipping. Everything else — sync, transcription, the multicam cut, captions — works with no key and no account. You can paste one in later behind the gear icon.",
  },
  {
  ...
  },
  {
    ...
    a: "Losh Parajuli, a software engineer who got tired of spending entire nights matching waveforms for a one-hour conversation and built the tool he wanted instead. autoBlade ships under fromSilicon.",
  },
];
